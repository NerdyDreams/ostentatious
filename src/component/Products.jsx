  ...
  useEffect(() => {
    const getProducts = async () => {
      ...
      if (componentMounted) {
        ...
        setFilter(await await response.json());
        setLoading(false);
        console.log(filter);
      }
      return () => {
    ...
    return (
      <>
        <div className="buttons d-flex justify-content-center mb-5 py-5">
          ...
          <button className="btn btn-outline-dark me-2" onClick={()=>filterProducts("men's clothing")}>Mens Clothing</button>
          <button className="btn btn-outline-dark me-2" onClick={()=>filterProducts("women's clothing")}>Womens Clothing</button>
          ...
          return (
            <>
              <div className="col-md-3 mb-4">
                <div className="card product-card h-100 text-center p-4" key = {product.id} >
